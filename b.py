...
# لیست دقیق پوشه‌ها و فایل‌های استثنا
...
def is_excluded_dir(dir_name):
    # نادیده گرفتن پوشه venv9 و سایر پوشه‌های venv و کش‌ها
...
def main():
    msg_id = send_msg("🚀 شروع فرایند بکاپ‌گیری (بدون پوشه venv9)...")
    
    file_list = []
    for root, dirs, files in os.walk('.'):
        # فیلتر کردن پوشه‌ها (حذف venv9)
    ...
    print(f"شروع فشرده‌سازی {total_files} فایل (بدون venv9)...")
    last_percent = -1
    ...
    with zipfile.ZipFile(ZIP_NAME, 'w', zipfile.ZIP_DEFLATED) as z:
        for idx, fp in enumerate(file_list, 1):
            ...
            # بروزرسانی پیام تلگرام هر ۱۰ درصد
